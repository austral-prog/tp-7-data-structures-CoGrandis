...
def convert_coordinate(coordenada):
    ...
    """
    tupla_coordenada = (coordenada[0], coordenada[1])
    return tupla_coordenada
...
def create_record(registro_azara, registro_rui):
    ...
    """
    coordenadas_rui = f'{registro_rui[1][0]}{registro_rui[1][1]}'

    if registro_azara[1] == coordenadas_rui :
        registro_combinado =  registro_azara[0], registro_azara[1] , registro_rui[0], registro_rui[1], registro_rui[2]
